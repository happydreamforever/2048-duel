...
/**
 * Accepts the three common ways of writing a MySQL address:
 *  - `jdbc:mysql://host:3306/db?sslMode=REQUIRED`          (JDBC, credentials separate)
 *  - `mysql://user:password@host:3306/db?ssl-mode=REQUIRED` (cloud-provider URI, credentials inside)
 *  - `host:3306/db`                                          (shorthand)
 */
object DatabaseUrl {
